          ...
          <div className="max-w-6xl mt-20 sm:mt-10 text-center">
            <div className="leading-10 font-light font-host-grotesk lg:text-2xl sm:text-lg md:text-xl tracking-wide">
              <TextAnimate animation="blurInUp" by="character" duration={3}>
                I'm Shubham Pawade, a Full Stack MERN Developer passionate about
                building robust and scalable web applications. With expertise in
                MongoDB, Express.js, React, and Node.js, I create seamless
                end-to-end solutions. I specialize in designing efficient
                databases, building RESTful APIs, and crafting responsive
                frontends. My focus is on writing clean, maintainable code while
                following best practices for performance and security. I'm always
                exploring new technologies to enhance my full-stack development
                skills and deliver exceptional digital experiences.
              </TextAnimate>
            </div>
          </div>
        </div>
