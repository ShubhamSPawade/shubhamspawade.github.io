      ...
      <div className="py-32 md:pd-[100px] md:py-48 lg:py-40 relative overflow-x-clip">
        ...
        <div className="container">
          ...
          <div className="max-w-lg mx-auto">
            ...
            <div className="mt-4 text-center text-white/60 md:text-lg">
              <TextAnimate
                ...
                once
              >
                I build end-to-end web applications using the MERN stack (MongoDB, Express.js, React, Node.js). From designing scalable backends to crafting intuitive frontends, I bring ideas to life with clean, efficient code and modern development practices.
              </TextAnimate>
            </div>
          </div>
          <div className="flex flex-col items-center md:flex-row justify-center mt-8 gap-4 ">
            ...
            <a
              href="https://drive.google.com/file/d/1MPYdVHX48n4rgBa8qSwpGR1h0qgEiOy8/view?usp=sharing"
              target="_blank"
